...
@Entity
@Table(name = "jm_journal_reviewer")
public class EntityJournalReviewer {
    ...
    @JoinColumn(name = "journal_id", foreignKey = @ForeignKey(name = "fk_jm_journal_reviewer_journal_id"), updatable = false, nullable = false)
    private EntityJournal journal;

    @ManyToOne(cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JoinColumn(name = "user_id", foreignKey = @ForeignKey(name = "fk_jm_journal_reviewer_user_id"), updatable = false, nullable = false)
    ...
    @ManyToOne(cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JoinColumn(name = "created_by", foreignKey = @ForeignKey(name = "fk_jm_journal_reviewer_created_by"), nullable = false, updatable = false)
