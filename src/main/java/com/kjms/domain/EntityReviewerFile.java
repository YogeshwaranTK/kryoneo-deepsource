...
@Entity
@Table(name = "jm_reviewer_file")
public class EntityReviewerFile {
    ...
    @JoinColumn(name = "review_round_id", foreignKey = @ForeignKey(name = "fk_jm_reviewer_file_review_round_id"),nullable = false)
    private EntityReviewRound reviewRound;

    @ManyToOne(cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JoinColumn(name = "file_type_id", foreignKey = @ForeignKey(name = "fk_jm_reviewer_file_file_type_id"),nullable = false)
    private EntityJournalFileType journalFileType;

    @ManyToOne(cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JoinColumn(name = "review_round_reviewer_id", foreignKey = @ForeignKey(name = "fk_jm_reviewer_file_review_round_reviewer_id"),nullable = false)
    ...
    @ManyToOne(cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JoinColumn(name = "created_by", foreignKey = @ForeignKey(name = "fk_jm_reviewer_file_created_by"))
