...
export const ReviewList = () => {
  ...
  const getSubmissionFromProps = () => {
    dispatch(
      getSubmissionList({
        submissionListRequestType: submissionWorkflowConfig.submissionListPeerReviewType,
    ...
    const endURL = `?submissionListRequestType=${submissionWorkflowConfig.submissionListPeerReviewType}&page=${pagination.activePage}&sort=${pagination.sort},${pagination.order}`;
  ...
  const statusSetFunction = (e) => {
    if (e === 'SUBMITTED') {
      return <> <span className="green-dot"></span>Moved To Review</>
    }
          ...
          <div className="tab-content" id="nav-tabContent">
            <div className="d-flex  b-bottom pb-2 pt-2">
              ...
              <div className="p-2 m-top w-25 input-icons">
                ...
                <img alt={'search-tables'} src='content/images/header-image/search-datatable.svg' className="search_datatable_icon"/>
              </div>
            ...
            <div id="custom-table">
              {loadingDownload ? <LoaderMain/> : null}
                ...
                <>
                  <table className="table">
                    ...
                    <tr>
                      ...
                      <th scope="col" style={{width: '28%'}} className="hand" onClick={sort('status')}>
                        Status
                        <span className="ps-1">
                          <FontAwesomeIcon icon="sort" className="icon-size"/>
                        </span>
                    ...
                    {article?.map((journal, i) => (
                      <tr id={journal.id} key={`user-${i}`}>
                        ...
                        <td>
                          {
                            <Link className="ar-details_list" to={`/journal/${Jo_id}/review`} state={journal.id}>
                              {journal.title}
                            </Link>
                          }
                        </td>
                        ...
                        <td>
                          <SubmissionButtonDropList journal={journal}
                                                    Jo_id={Jo_id}
