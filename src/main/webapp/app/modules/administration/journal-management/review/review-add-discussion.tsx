...
import { reviewAddDiscussionRequest } from "./reviewReducer";
...
const AddDiscussionReview = (props) => {
  ...
  const {
    ...
    submissionId,
    reviewRoundId,
    setProductionDiscussionList,
    productionDiscussionList
  } = props;

  const addDiscussionSuccess = useAppSelector(state => state.review.addDiscussionSuccess);
  const reviewAddDiscussionPayload = useAppSelector(state => state.review.reviewAddDiscussionPayload);
  ...
  const validateForm = () => {
    ...
    if (participantList.length === 0) {
      errorsValidate.userListError = translate("ADD_DISCUSSION_TITLE.Select_at_least_one_participant");
    }
    if (subjectInputValue === '') {
      errorsValidate.subjectInputValueError = translate("ADD_DISCUSSION_TITLE.Subject_is_required");
    }
    if (discussionDescription.length === 0) {
      errorsValidate.description_error = translate("ADD_DISCUSSION_TITLE.Required_Description")
    }
  ...
  const HandleSubmit = () => {
    ...
    if (validateForm()) {
      dispatch(reviewAddDiscussionRequest(data));
    }
  }
        ...
        <div className="modal-content">
          <div className="modal-header">
            <div className="d-flex">
              ...
              <div className="d-flex">
                <h5 className="m-0"><Translate contentKey="ADD_DISCUSSION_TITLE.ADD_DISCUSSION"></Translate></h5>
              </div>
            </div>
            <button
              type="button"
          ...
          <div className="modal-body ps-4 position-relative">
            ...
            <p className="request-sub-head m-0"><Translate contentKey="ADD_DISCUSSION_TITLE.Participants"></Translate><span
            ...
            <div className="pt-3">
              <label className="form-label article_custom_label"><Translate contentKey="ADD_DISCUSSION_TITLE.Subject"></Translate><span className="error_class">*</span></label>
              <input
                name="title"
                id="title"
                placeholder={translate("ADD_DISCUSSION_TITLE.Enter_Subject")}
                data-cy="title"
                type="text"
            ...
            <div className="pt-3">
              <label className="form-label">
                <Translate contentKey="ADD_DISCUSSION_TITLE.Message"></Translate><span className="error_class">*</span>
            ...
            <div className="col-12 pb-3 " id="custom-form-input">
              <div className='row mt-3'>
                <div className="col-4">
                  <label className="form-label">
                    <Translate contentKey="ADD_DISCUSSION_TITLE.Message"></Translate>
                  </label>
                ...
                <div className="col-8">
                  <label className="form-label">
                    <Translate contentKey="ADD_DISCUSSION_TITLE.Upload_File"></Translate>
                  </label>
            ...
            {selectedFiles?.length > 0 ?
              <table className="table work-flow_table">
                ...
                <tr>
                  ...
                  <th scope="col" className="hand">
                    <Translate contentKey="ADD_DISCUSSION_TITLE.File_Name"></Translate>
                  </th>
                  <th scope="col" className="hand">
                    <Translate contentKey="ADD_DISCUSSION_TITLE.File_Type"></Translate>
                  </th>
                  <th scope="col" className="hand">
                    <Translate contentKey="ADD_DISCUSSION_TITLE.File_Format"></Translate>
                  </th>
                  <th scope="col" className="hand">
                    <Translate contentKey="ADD_DISCUSSION_TITLE.Action"></Translate>
                  </th>
                </tr>
                </thead>
                <tbody>
              ...
              <div className='pb-4 pb-3 text-center'><Translate contentKey="ADD_DISCUSSION_TITLE.Upload_files_not_found."></Translate></div>
            }


            <div className="modal-footer">
              <button type={"submit"} onClick={HandleSubmit} className="btn btn--cancel">
                <Translate contentKey="ADD_DISCUSSION_TITLE.ADD_DISCUSSION"></Translate>
              </button>
              <button
                className="btn btn--cancel"
                type="button" onClick={handleCancel}>
                <Translate contentKey="ADD_DISCUSSION_TITLE.CANCEL"></Translate>
              </button>
            </div>
          </div>
        </div>
...
export default AddDiscussionReview;
