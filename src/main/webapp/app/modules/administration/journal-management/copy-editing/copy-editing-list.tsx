...
export const CopyEditingList = () => {
  ...
  const getSubmissionFromProps = () => {
    dispatch(
      getSubmissionList({
        submissionListRequestType: submissionWorkflowConfig.submissionListCopyEditingType,
    ...
    const endURL = `?submissionListRequestType=${submissionWorkflowConfig.submissionListCopyEditingType}&page=${pagination.activePage}&sort=${pagination.sort},${pagination.order}`;
  ...
  const statusSetFunction = (e) => {
    if (e === 'MOVED_TO_COPY_EDITING') {
      return <> <span className="green-dot"></span>Moved To Copy Editing</>
    }
          ...
          <div className="tab-content" id="nav-tabContent">
            <div className="d-flex  b-bottom pb-2 pt-2">
              ...
              <div className="p-2 m-top w-25 input-icons">
                ...
                <img alt={'search-datatable'} src='content/images/header-image/search-datatable.svg' className="search_datatable_icon"/>
              </div>
                  ...
                  <table className="table">
                    ...
                    {article?.map((journal, i) => (
                      <tr id={journal.id} key={`user-${i}`}>
                        ...
                        <td>
                          {
                            <Link className="ar-details_list" to={`/journal/${Jo_id}/copy-editing`} state={journal.id}>
                              {journal.title}
                            </Link>
                          }
                        </td>
...
export default CopyEditingList;
