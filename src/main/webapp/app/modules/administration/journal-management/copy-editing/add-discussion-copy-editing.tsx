...
import {postAddDiscussionRequest} from "app/modules/administration/journal-management/copy-editing/copy-editing.reducer";
...
const AddDiscussionCopyEditing = (props) => {
  ...
  const {
    ...
    participantLists,
    submissionId,
    setCopyEditingDiscussionList,
    copyEditingDiscussionList

  } = props;
  const addDiscussionSuccess = useAppSelector(state => state.copyEditing.addDiscussionSuccess);
  const postAddDiscussionPayload = useAppSelector(state => state.copyEditing.postAddDiscussionPayload);
  ...
  useEffect(() => {
    if (addDiscussionSuccess === true) {
      ...
      const updatedDiscussionList = [...copyEditingDiscussionList, postAddDiscussionPayload];

      setCopyEditingDiscussionList(updatedDiscussionList);
      handleCancel();
      dispatch(stateFalse())
    }
...
export default AddDiscussionCopyEditing;
