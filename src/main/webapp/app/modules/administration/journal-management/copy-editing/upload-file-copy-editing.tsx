...
import {stateFalse} from "app/modules/administration/journal-management/production/production.reducer";
...
const UploadFilesCopyEditing = (props) => {
  ...
  useEffect(() => {
    if (fileUploadCopyEditingReadyFilesSuccess === true) {
      handleCancel()
    }
  }, [fileUploadCopyEditingReadyFilesSuccess])
...
export default UploadFilesCopyEditing;
