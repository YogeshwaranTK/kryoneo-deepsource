...
import {postAddDiscussionRequest} from "app/modules/administration/journal-management/production/production.reducer";
...
const AddDiscussionProduction = (props) => {
  ...
  const addDiscussionSuccess = useAppSelector(state => state.production.addDiscussionSuccess);
  const postAddDiscussionPayload = useAppSelector(state => state.production.postAddDiscussionPayload);
  ...
  useEffect(() => {
    if (addDiscussionSuccess === true) {
      const updatedDiscussionList = [...productionDiscussionList, postAddDiscussionPayload];
...
export default AddDiscussionProduction;
