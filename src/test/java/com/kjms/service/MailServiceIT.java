...
//
//    @Test
//    void testSendEmailOtp() throws MessagingException, IOException {
//        String defaultEmail = "john.doe@example.com";
//
//        mailService.sendEmailOtp(defaultEmail, "123456");
//
//        verify(javaMailSender).send(messageCaptor.capture());
//        MimeMessage message = messageCaptor.getValue();
//
//        assertThat(message.getAllRecipients()[0]).hasToString(defaultEmail);
//        assertThat(message.getFrom()[0]).hasToString(jHipsterProperties.getMail().getFrom());
//        assertThat(message.getContent().toString()).isNotEmpty();
//        assertThat(message.getDataHandler().getContentType()).isEqualTo("text/html;charset=UTF-8");
//    }
//
//    @Test
//    void testSendOtpEmailFromTemplate() throws Exception {
//        String defaultEmail = "123456";
//        String subject = "Email Verification";
//
//        mailService.sendOtpEmailFromTemplate("123456", defaultEmail, "mail/otpEmail", subject);
//        verify(javaMailSender).send(messageCaptor.capture());
//        MimeMessage message = messageCaptor.getValue();
