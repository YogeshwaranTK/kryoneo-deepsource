...
//import com.kjms.domain.Authority;
...
//
//    private static final String DEFAULT_ID = "f519502d-9b1a-464e-ba35-9e2f2864dea7";
//
...
//     */
//    public static EntityUser createEntity(EntityManager em) {
...
//     */
//    public static EntityUser initTestUser(EntityUserRepository userRepository, EntityManager em) {
//        //        userRepository.deleteAll();
//        EntityUser user = createEntity(em);
//        user.setId(DEFAULT_ID);
...
//
//        // Update the user
//        EntityUser updatedUser = userRepository.findById(user.getId()).get();
//
//        ManagedUserVM managedUserVM = new ManagedUserVM();
...
//            EntityUser testUser = users.stream().filter(usr -> usr.getId().equals(updatedUser.getId())).findFirst().get();
...
//        TestUtil.equalsVerifier(EntityUser.class);
//        EntityUser user1 = new EntityUser();
//        user1.setId(DEFAULT_ID);
//        EntityUser user2 = new EntityUser();
//        user2.setId(user1.getId());
//        assertThat(user1).isEqualTo(user2);
//        user2.setId("f519502d-9b1a-464e-ba35-9e2f2864dea3");
...
//
//        AccountUser userDTO = userMapper.userToAdminUserDTO(user);
//
