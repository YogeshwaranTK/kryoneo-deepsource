...
//
//import static com.kjms.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
//import com.kjms.repository.AuthorityRepository;
//import com.kjms.repository.EntityUserRepository;
//import com.kjms.security.AuthoritiesConstants;
//import com.kjms.service.UserService;
//import com.kjms.service.dto.AccountUser;
//import com.kjms.service.dto.PasswordChange;
//import com.kjms.web.rest.vm.KeyAndPasswordVM;
//import com.kjms.web.rest.vm.ManagedUserVM;
...
//
//        Optional<EntityUser> user = userRepository.findOneByEmailIgnoreCase("funky@example.com");
...
//            .andExpect(status().isBadRequest());
//
//        Optional<EntityUser> user = userRepository.findOneByLogin("bob");
//        assertThat(user).isEmpty();
//    }
//
//    @Test
...
//            .andExpect(status().isCreated());
//
//        Optional<EntityUser> testUser = userRepository.findOneByEmailIgnoreCase("alice2@example.com");
...
//            .andExpect(status().isCreated());
//
//        Optional<EntityUser> testUser1 = userRepository.findOneByLogin("test-register-duplicate-email");
...
//            .andExpect(status().isCreated());
//
//        Optional<EntityUser> testUser2 = userRepository.findOneByLogin("test-register-duplicate-email");
//        assertThat(testUser2).isEmpty();
//
//        Optional<EntityUser> testUser3 = userRepository.findOneByLogin("test-register-duplicate-email-2");
...
//            .andExpect(status().isCreated());
//
//        Optional<EntityUser> testUser4 = userRepository.findOneByLogin("test-register-duplicate-email-3");
//        assertThat(testUser4).isPresent();
//        assertThat(testUser4.get().getEmail()).isEqualTo("test-register-duplicate-email@example.com");
//
//        testUser4.get().setActivated(true);
//        userService.updateUser((new AccountUser(testUser4.get())));
//
...
//            .andExpect(status().isCreated());
//
//        Optional<EntityUser> userDup = userRepository.findOneWithAuthoritiesByLogin("badguy");
...
//        userRepository.saveAndFlush(user);
//
//        AccountUser userDTO = new AccountUser();
...
//            .andExpect(status().isOk());
//
//        EntityUser updatedUser = userRepository.findOneWithAuthoritiesByLogin(user.getLogin()).orElse(null);
...
//        userRepository.saveAndFlush(user);
//
//        EntityUser anotherUser = new EntityUser();
...
//            .andExpect(status().isBadRequest());
//
//        EntityUser updatedUser = userRepository.findOneByLogin("save-existing-email").orElse(null);
...
//            .andExpect(status().isOk());
//
//        EntityUser updatedUser = userRepository.findOneByLogin("save-existing-email-and-login").orElse(null);
...
//            .andExpect(status().isBadRequest());
//
//        EntityUser updatedUser = userRepository.findOneByLogin("change-password-wrong-existing-password").orElse(null);
...
//            .andExpect(status().isOk());
//
//        EntityUser updatedUser = userRepository.findOneByLogin("change-password").orElse(null);
...
//            .andExpect(status().isBadRequest());
//
//        EntityUser updatedUser = userRepository.findOneByLogin("change-password-too-small").orElse(null);
//        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
//    }
//
//    @Test
...
//            .andExpect(status().isBadRequest());
//
//        EntityUser updatedUser = userRepository.findOneByLogin("change-password-too-long").orElse(null);
//        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
//    }
//
//    @Test
...
//            .andExpect(status().isBadRequest());
//
//        EntityUser updatedUser = userRepository.findOneByLogin("change-password-empty").orElse(null);
//        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
//    }
//
//    @Test
...
//            .andExpect(status().isOk());
//
//        EntityUser updatedUser = userRepository.findOneByLogin(user.getLogin()).orElse(null);
